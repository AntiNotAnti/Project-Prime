...
public sealed class ServerUpdateRuntimeTests
{
    ...
    private sealed class Fixture : IDisposable
    {
        ...
        public static Fixture Managed()
        {
            ...
            string executable = Path.GetFileName(typeof(ServerUpdate).Assembly.Location);
            File.WriteAllText(Path.Combine(destination, Path.ChangeExtension(executable, ".runtimeconfig.json")),
                "{\"runtimeOptions\":{\"tfm\":\"net10.0\",\"framework\":{\"name\":\"Microsoft.NETCore.App\",\"version\":\"10.0.0\"}}}");
            result.Seal(executable);
            return result;
        }
