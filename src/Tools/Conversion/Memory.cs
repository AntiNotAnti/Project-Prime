...
namespace MphRead.Memory
{
    public class Memory
    {
        ...
        private Memory(Process process, CancellationToken cancellationToken)
        {
            _process = process;
        ...
        public static Memory Start(CancellationToken cancellationToken = default, bool blocking = true)
        {
            ...
            var memory = new Memory(foundProcess, cancellationToken);
            memory.Run(blocking);
            return memory;
        }
