...
namespace MphRead.Entities
{
    ...
    {
        internal readonly TriggerVolumeEntityData _data;
        ...
        internal readonly Vector3 _parentEventColor;
        internal readonly Vector3 _childEventColor;
        ...
        public override bool Process()
        {
            ...
            else if (_data.Subtype == TriggerType.StateBits)
            {
                ...
                if (_scene.IsTriggerStateSet(index))
                {
                    Trigger();
                }
            }
    ...
    {
        internal readonly FhTriggerVolumeEntityData _data;
        private EntityBase? _parent = null;
        private EntityBase? _child = null;
        internal readonly CollisionVolume _volume;
        internal readonly Vector3 _parentEventColor;
