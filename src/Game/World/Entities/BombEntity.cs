...
namespace MphRead.Entities
{
    public class BombEntity : EntityBase
    {
        ...
        public override void Initialize()
        {
            ...
            {
                Countdown = SimTicks.From30HzFrames(43);
                effectId = _scene.Players.ActiveCount > 2 ? 119 : 9; // bombStartMP or bombStart
            }
            if (effectId != 0)
            {
        ...
        public static BombEntity? Spawn(PlayerEntity owner, Matrix4 transform, Scene scene)
        {
            ...
            scene.Services.Combat?.NoteBomb(bomb.CombatShot, type, bomb.Position, bomb.FacingVector);
            return bomb;
        }
    }
