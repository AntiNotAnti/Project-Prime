...
namespace MphRead.Entities
{
    public class NodeDefenseEntity : EntityBase
    {
        ...
        internal int _currentTeam = NeutralTeam;
        internal int _occupyingTeam = NeutralTeam;
                ...
                else if (_currentTeam != _occupyingTeam)
                {
                    if (_occupiedBy[PlayerEntity.Main.SlotIndex])
                    {
                        if (!_inProgress && _progressTicks >= SimTicks.From30HzFrames(10))
                        {
                            ...
                            {
                                _scene.Audio.PlayRoomMusic(_scene.RoomId, track: 2);
                            }
                            value1 = 1;
                            _inProgress = true;
                        }
        ...
        internal static readonly ColorRgb _neutralColor = new ColorRgb(31, 31, 31);
        internal static readonly ColorRgb _selfColor = new ColorRgb(15, 15, 31);
        internal static readonly ColorRgb _enemyColor = new ColorRgb(31, 0, 0);
