...
namespace MphRead
{
    public static class Read
    {
        ...
        {
            ContentFiles.NotifyModelReading(name, dir, firstHunt);
            ModelMetadata? meta;
            if (firstHunt)
            {
        ...
        {
            return new ReadOnlySpan<byte>(ContentFiles.ReadBytes(Paths.Combine(firstHunt ? Paths.FhFileSystem : Paths.FileSystem, path)));
        }
