...
namespace MphRead.Entities
{
    ...
    public partial class PlayerEntity
    {
        ...
        internal void ModRefreshNetworkAim()
        {
            ...
            if (_scene.Services.TryGetRemoteAim(SlotIndex, out Vector3 remoteAim))
            {
                ModSetAim(remoteAim);
            }
        }
        ...
        internal void ModRefreshNodeRef(OpenTK.Mathematics.Vector3 previousPosition)
        {
            ...
            _scene.Services.CountUnresolvedNode();
        ...
        /// </summary>
        internal bool ModNodeUnresolved { get; set; }
        ...
        {
            _scene.Services.NoteCollisionRange(SlotIndex, PrevPosition, Position);
        }
        ...
        internal void ModRepairVectors()
        {
            ...
            else
            {
                ...
                _scene.Services.NoteEvent($"slot {SlotIndex} facing repaired, {ModFormState()}, gun={_gunVec1}");
            }
            if (Finite(_gunVec1))
            {
            ...
            else
            {
                ...
                _scene.Services.NoteEvent($"slot {SlotIndex} aim repaired");
            }
            if (Finite(Position))
            {
            ...
            else
            {
                ...
                _scene.Services.NoteEvent($"slot {SlotIndex} position repaired");
            }
            if (!Finite(Speed))
            {
