...
namespace MphRead.Entities
{
    ...
    {
        protected internal Vector3 _light1Vector;
        protected internal Vector3 _light1Color;
        protected internal Vector3 _light2Vector;
        protected internal Vector3 _light2Color;
        ...
        protected internal bool _useRoomLights = false;
        ...
        protected internal override LightInfo GetLightInfo()
        {
            if (_useRoomLights)
            {
