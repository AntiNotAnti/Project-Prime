...
namespace MphRead.Mods.Network
{
    ...
    public static class ServerContentValidation
    {
            ...
            bool hosting = false)
        {
            ...
            {
                foreach (string room in ServerContentPack.RetailRooms) { AddModes(scenarios, room); }
            ...
            foreach (ServerContentScenario scenario in scenarios)
            {
                ...
                // spawn layouts, matching ServerContentPack.ProbeScenarios. Parser
        ...
        private static bool Probe(ServerContentScenario scenario)
        {
            ...
            try
            {
                ...
                bool objectives = ServerContentPack.HasObjectives(scene, scenario.Mode);
                int spawned = 0;
