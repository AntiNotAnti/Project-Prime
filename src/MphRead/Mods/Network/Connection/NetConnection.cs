...
namespace MphRead.Mods.Network
{
    ...
    public sealed class NetConnection
    {
        ...
        public void Send(NetTransport transport, NetMessageType type, ReadOnlySpan<byte> payload = default)
        {
        ...
        public void FlushReliable(NetTransport transport, double now)
        {
            Span<byte> datagram = stackalloc byte[NetConfig.MaxPacketSize];
