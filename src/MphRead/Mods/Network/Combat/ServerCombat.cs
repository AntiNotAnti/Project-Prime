...
namespace MphRead.Mods.Network
{
    ...
    public sealed class ServerCombat
    {
        ...
        internal bool TryGetPlayerCollider(PlayerEntity player, in CombatShot shot, out LagCompensationState state)
        {
        ...
        internal void NoteSpawn(PlayerEntity player)
        {
        ...
        internal void NoteDamage(PlayerEntity victim, EntityBase? source, PlayerEntity? attacker, BeamType weapon,
