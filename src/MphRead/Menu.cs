...
namespace MphRead
{
    ...
    public class MenuSettings()
    {
        ...
        public string SharpenStrength { get; set; } = "0";
        public string Bloom { get; set; } = "off";
        public string BloomIntensity { get; set; } = "60";
        public string ColorGrade { get; set; } = "original";
        public string Gamma { get; set; } = "100";
        ...
        public string VolumetricFog { get; set; } = "off";
