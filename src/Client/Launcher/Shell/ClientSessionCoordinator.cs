...
{
    Gateway, OnlineHome, Lobby, Launching, InMatch, Results, ReturningToLobby, Closing
}
...
public sealed class ClientSessionCoordinator
{
    ...
    {
        Require(ClientSessionPhase.Gateway, ClientSessionPhase.OnlineHome, ClientSessionPhase.Lobby, ClientSessionPhase.Results);
        LastResult = null;
