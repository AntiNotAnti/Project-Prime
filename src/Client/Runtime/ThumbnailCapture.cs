...
namespace MphRead.Mods
{
    ...
    public sealed class ThumbnailCapture : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            if (!_describedContext)
            {
                ...
                string line = $"build {Update.BuildVersion.Display} / "
                    ...
                    + $"offscreen target {Presentation.FramebufferStatus}";
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            // just rendered.
            _frameError = Presentation.DrainGlError();
            bool giveUp = false;
            ...
            if (!_captured)
            {
                ThumbnailLog.Write($"{_roomKey}: attempt {_attempts + 1} produced nothing usable "
                    + $"(target {Presentation.FramebufferStatus}, first GL error this frame {_frameError})");
