...
namespace MphRead
{
    public partial class ScenePresentation
    {
        ...
        private readonly ConditionalWeakTable<Mesh, Binding> _meshBindings = new();
        ...
        public int GetMeshListId(Mesh mesh) => _meshBindings.GetOrCreateValue(mesh).Id;
        public void SetMeshListId(Mesh mesh, int id) => _meshBindings.GetOrCreateValue(mesh).Id = id;
