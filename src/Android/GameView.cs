...
namespace MphRead.Droid
{
    ...
    internal sealed class GameView : SurfaceView, ISurfaceHolderCallback
    {
        ...
        private sealed class RenderLoop
        {
            ...
            /// the keyboard and <c>ScenePresentation.Get(Scene).OnMouseMove</c> turns it. This head
            ...
            private void Spectate()
            {
                ...
                if (freeCamera)
                {
                    ...
                    if (look.X != 0 || look.Y != 0)
                    {
                        ...
                        if (Scene != null) ScenePresentation.Get(Scene).OnMouseMove(look.X * AimScale, look.Y * AimScale);
                    }
                }
                else
                {
            ...
            private void CollectInput(PlayerEntity main)
            {
                ...
                ClientPlayerBindings controls = main.GetPresentation().Bindings;
                TouchControls.Dir dir = _controls.Direction;
