# G1 baseline — Project Prime

- Repository: `/Users/jarrett/Documents/Development/Project-Prime`
- Baseline commit: `b31bc5764b01da0d8dac8b1f261b11e2d791e312`
- SDK: `/tmp/codex-re-project-prime-refactor/dotnet10/dotnet` (`10.0.400`)
- Data gate for the main C# tests: `GAME_DATA_DIRECTORY=/Users/jarrett/Documents/Development/Project-Prime/AMHE1`
...
|---|---|---|
| Game solution Release build | `/tmp/codex-re-project-prime-refactor/dotnet10/dotnet build Game.sln -c Release --artifacts-path /private/tmp/codex-re-prime-g1/baseline/solution` | **PASS**, 0 errors, 6 NU1903 warnings |
| Main C# tests | `env GAME_DATA_DIRECTORY=/Users/jarrett/Documents/Development/Project-Prime/AMHE1 /tmp/codex-re-project-prime-refactor/dotnet10/dotnet test tests/Tests/Tests.csproj -c Release --artifacts-path /private/tmp/codex-re-prime-g1/baseline/main` | **PASS**, 434 passed, 0 failed, 0 skipped |
| Isolated imaging tests | `/tmp/codex-re-project-prime-refactor/dotnet10/dotnet test tests/Imaging/Imaging.Tests.csproj -c Release --artifacts-path /private/tmp/codex-re-prime-g1/baseline/imaging` | **PASS**, 18 passed, 0 failed, 0 skipped |
| Python tests | `python3 -m unittest discover -s tools/tests -p 'test_*.py' -v` | **PASS**, 47 tests, 0 failures |
| Nettest Release build | `/tmp/codex-re-project-prime-refactor/dotnet10/dotnet build tools/nettest/nettest.csproj -c Release --artifacts-path /private/tmp/codex-re-prime-g1/baseline/nettest` | **PASS**, 0 errors, 4 NU1903 warnings |
...
|---|---|---|
| `--match-lifecycle DATA` | Child refuses server launch | Fixture still launches `ProjectPrime.dll -server` instead of standalone Server |
